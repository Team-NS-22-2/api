...
//    private final RefreshTokenService refreshTokenService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .antMatchers("/acc/report/**").hasRole(UserType.ROLE_CUSTOMER.getRole())
                .antMatchers("/acc/submit/**").hasRole(UserType.ROLE_CUSTOMER.getRole())
                .antMatchers("/acc/claim/**").hasRole(UserType.ROLE_CUSTOMER.getRole())
