...
public class AccidentDaoImpl extends Dao implements AccidentDao {
    ...
    public Accident read(int id) {
        ...
        if (ac == null) {
            throw new MyIllegalArgumentException(ConsoleColors.RED_BOLD+"ERROR !! : 사고 아이디 ["+id+"]에 해당하는 사고 정보가 존재하지 않습니다."+ ConsoleColors.RESET);
        }
        return ac;
    }
    ...
    public List<Accident> readAllByCustomerId(int customerId) {
        ...
        if(accidents.isEmpty())
         throw new NoResultantException(ConsoleColors.RED_BOLD+"ERROR !! : 고객 아이디 ["+customerId+"]에 해당하는 사고 정보가 존재하지 않습니다."+ ConsoleColors.RESET);
        return  accidents;
    }
    ...
    public List<Accident> readAllByEmployeeId(int employeeId) {
        ...
        if(accidents.isEmpty())
            throw new NoResultantException(ConsoleColors.RED_BOLD+"ERROR !! : 보상팀 아이디 ["+employeeId+"]에 해당하는 사고 정보가 존재하지 않습니다."+ ConsoleColors.RESET);
        return accidents;
    }
